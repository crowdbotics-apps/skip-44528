"""
Django settings for skip_44528 project.
...
WSGI_APPLICATION = 'skip_44528.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "skip_44528 API",
    "DESCRIPTION": "API documentation for skip_44528 App",
    "VERSION": "v1",
}
